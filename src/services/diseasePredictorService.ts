...
export const useDiseasePredictor = () => {
  ...
  return usePost<DiseasePredictorResponse, DiseasePredictorRequest>(
    ...
    {
      onSuccess: (
        response: ApiResponse<DiseasePredictorResponse>,
        variables: DiseasePredictorRequest,
      ) => {
...
export const transformDiseasePredictorFormData = (
  formData: any,
): DiseasePredictorRequest => {
...
export const formatDiseasePredictorResponse = (
  response: DiseasePredictorResponse,
): { prediction: string } => {
