...
export const useFeedCalculator = () => {
  ...
  return usePost<FeedCalculatorResponse, FeedCalculatorRequest>(
    ...
    {
      onSuccess: (response: ApiResponse<FeedCalculatorResponse>, variables: FeedCalculatorRequest) => {
      ...
      onError: (error: any) => {
        ...
        let errorMessage = 'Failed to calculate feed requirements. Please try again.';
...
export const transformFormDataToApiRequest = (formData: any): FeedCalculatorRequest => {
...
export const formatApiResponseForDisplay = (response: FeedCalculatorResponse) => {
