...
export const ACTIVITIES = {
  ...
  GET_USER_NOTIFICATIONS_BY_ID: (Id: string) =>
    `/v3/get-notification/${Id}/notification`,
};
...
export const FORUM_CHAT = {
  ...
  GET_VISIBILITY_OPTIONS: (visibility: string) =>
    `/v3/forums/get-visibility-options/${visibility}/forums`,
...
export const VETERINARY_CLINIC = {
  ...
  GET_VET_CLINIC_BY_ID: (Id: string) =>
    `/v3/get-veterinary-clinic/${Id}/clinic`,
};
...
export const VETERINARY_PARAPROFESSIONAL = {
  ...
  GET_VET_PARA_BY_ID: (Id: string) =>
    `/v3/get-veterinary-paraprofessional/${Id}/paraprofessional`,
};
