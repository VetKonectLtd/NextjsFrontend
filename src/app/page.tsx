  ...
  const ctaData = [
    {
      ...
      description:
        "Easily connect with Veterinarians and Paraprofessionals near you.",
      isReversed: false,
      showOpenStatus: true,
    ...
    },
    {
      ...
      description:
        "Access Veterinary clinics near you for your pets and livestock",
      isReversed: true,
      showOpenStatus: true,
      showLocationIcon: true,
    },
    {
      ...
      description:
        "Connect to a pool of vendors for all of your animal needs or sell easily.",
      isReversed: false,
      showOpenStatus: true,
      showLocationIcon: true,
    },
