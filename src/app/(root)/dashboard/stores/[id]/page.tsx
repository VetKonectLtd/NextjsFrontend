    ...
    <div className="min-h-screen w-11/12 mt-3 m-auto shadow-md border rounded-2xl border-gray-225 bg-white">
      ...
      <div className="flex max-w-sm px-4 md:px-0 m-auto flex-col items-center -mt-12">
        ...
        <Link
          ...
          className="flex max-w-sm items-center justify-between w-full border-2 bg-white border-green-50 rounded-xl p-2 pl-3 mt-8 transition"
        >
          <span className="text-gray-55 text-sm font-bold">
            Add New Product
          </span>
          <span className="w-8 h-8 flex items-center justify-center bg-green-50 text-white rounded-xl text-xl">
