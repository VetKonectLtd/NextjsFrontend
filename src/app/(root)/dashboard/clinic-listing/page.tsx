...
export const metadata: Metadata = {
    ...
    description: "Add your veterinary clinic to Vet Konect and connect with pet owners in your area. Join our network of trusted veterinary professionals today.",
    openGraph: {
