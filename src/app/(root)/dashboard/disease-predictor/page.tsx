...
export default function DiseasePredictorPage() {
  ...
  const { useGetSymptom, useGetCategory, usePredictDisease } =
    useDiseasePredict();
  ...
  const animalSpeciesOptions = (category.data as any)?.categories?.length
  ...
  useEffect(() => {
    ...
    const unique = Array.from(new Set(list.map((s) => s.trim().toLowerCase())));
    setSymptomOptions(unique);
  }, [symptomMutation.data]);

  const filteredSymptoms = (
    symptomOptions.length > 0 ? symptomOptions : availableSymptoms
  ).filter((symptom) =>
  ...
  const isSymptomDropdownDisabled =
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Based on the signs and symptoms you have selected, the suspected
            condition is
          </p>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="font-semibold text-gray-900">{symptoms.join(", ")}</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <Button
            onClick={() =>
              route.push("/dashboard/vet-vendor?category=Veterinarian")
            }
            ...
            <Form {...form}>
              ...
              >
                ...
                <Button
                  ...
                  disabled={
                    !isFormValid() || diseasePredictorMutation.isPending
                  }
                >
                  {diseasePredictorMutation.isPending
                    ? "Predicting..."
                    : "Predict"}
                </Button>
              </form>
