...
} from "@/lib/validations/case-form";
...
const AddCasePage = () => {
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 1) {
      ...
      const step1Valid =
        currentData.caseTitle &&
        currentData.clientName &&
        currentData.clientPhoneNumber &&
        currentData.petOrFarm;
      ...
      if (currentData.petOrFarm === "Pet") {
        ...
        conditionalValid = !!(
          currentData.farmName &&
          currentData.typeOfLivestock &&
          currentData.numberOfLivestock &&
          currentData.numberOfWorkers
        );
      }
  ...
  const onSubmit = async (data: CaseFormData) => {
    ...
    try {
      ...
      if (
        res.success ||
        res.message === "Case created successfully" ||
        ((res as any).case && (res as any).case.case_id)
      ) {
        ...
        const errorMessage =
          res.message || res.data?.message || "Failed to add case";
  ...
  const isCurrentStepValid = () => {
    ...
    if (currentStep === 1) {
      ...
      return !!(
        currentData.dateOccurred &&
        currentData.clinicalSigns &&
        currentData.clinicalSigns.length > 0
      );
    }
    return false;
  };
      ...
      <div className="bg-white px-4 py-4">
        ...
        <div className="text-center mt-6 mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            <div
              className={`w-3 h-3 rounded-full ${currentStep >= 1 ? "bg-green-500" : "bg-gray-300"}`}
            ></div>
            <div
              className={`w-3 h-3 rounded-full ${currentStep >= 2 ? "bg-green-500" : "bg-gray-300"}`}
            ></div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                {form.formState.errors.clientPhoneNumber && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.clientPhoneNumber.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {form.formState.errors.petOrFarm && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.petOrFarm.message}
                  </p>
                )}
              </div>
                      ...
                      <>
                        ...
                        <div>
                          <input
                            ...
                            {...form.register("numberOfLivestock", {
                              valueAsNumber: true,
                            })}
                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                          />
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                {form.formState.errors.dateOccurred && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.dateOccurred.message}
                  </p>
                )}
              </div>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {form.formState.errors.clinicalSigns && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.clinicalSigns.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {form.formState.errors.clinicPhysicalAddress && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.clinicPhysicalAddress.message}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {form.formState.errors.mobileVeterinarian && (
                  <p className="text-red-500 text-sm mt-1">
                    {form.formState.errors.mobileVeterinarian.message}
                  </p>
                )}
              </div>
