...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with our support team for assistance with veterinary services, pet care, or any questions about Vet Konect.",
  openGraph: {
    title: "Customer Support | Vet Konect",
    description:
      "Need help? Contact our support team for assistance with veterinary services, pet care, or any questions about Vet Konect.",
    type: "website",
