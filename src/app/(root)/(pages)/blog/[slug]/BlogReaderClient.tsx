...
export default function BlogReaderClient({ slug }: BlogReaderClientProps) {
  ...
  const getSlugData = useGetBlogSlug(true, slug);
  ...
  return (
    <>
      ...
      <div className="absolute -left-[9999px] top-0">
        <div ref={pdfOnlyRef} className="w-[800px] bg-white p-5 pb-10">
        ...
        <div className="flex gap-4 items-center text-sm justify-start mt-4 pt-4">
          ...
          <div className="flex items-center">
            ...
            >
              <ThumbsUp
                size={14}
                color={activePost?.blog.has_liked ? "#0BA02C" : "#1D2432"}
