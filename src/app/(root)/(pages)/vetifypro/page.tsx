...
export default function VetifyProPage() {
  ...
  const { useInitiateSubscription } = useSubscriptionService();
          ...
          <div className="bg-[#575CEE] text-white rounded-3xl px-6 pt-2 md:px-14 grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 items-center">
            <div className="text-base md:text-lg font-medium">
              ...
              <p className="leading-relaxed mb-4">
                It lets you effortlessly record consultations, generate
                structured SOAP notes, and receive real-time, evidence-based
                differentials and treatment recommendations for both routine and
                complex cases. Notes can be instantly turned into clear,
                client-friendly summaries ready to share in one click, helping
                save up to two hours daily while improving accuracy and
                consistency.
              </p>
        ...
        <section className="max-w-7xl mx-auto px-6 pb-12 animate-fade-in-bottom">
          <div className="bg-white shadow-xl border-4 border-gray-100 rounded-3xl p-5 md:p-12">
            <p className="md:text-lg text-sm text-[#1E1E1E] leading-relaxed">
              VetifyPro is an AI Clinical Assistant designed to reduce
              diagnostic uncertainty and strengthen the confidence of every
              veterinarian on your team, whether in a fast-paced clinic, a
              sole-charge shift, or an emergency situation.
            </p>
            <p className="md:text-lg text-sm mt-7 text-[#1E1E1E] leading-relaxed">
              ...
              and horses to livestock, camels, and beyond. Continuously updated
              to reflect the latest veterinary literature, and with customisable
              clinical notes and plain-language client summaries, VetifyPro
              adapts to the way your clinic works. The result is a smarter, more
          ...
          >
            <div className="max-w-3xl relative z-10">
              ...
              <p className="md:text-lg text-sm font-medium text-black leading-relaxed mb-8">
                ...
                <strong className="text-[#0B6614] ml-1"> VetifyPro</strong>.
                <br />
