...
const VetAccount = ({
  ...
  const currentUserId = (currentUser as any)?.profile?.user_id?.toString?.();
      ...
      {selectedAction === "share" && (
        <>
          ...
          <p className="text-gray-800">
            https://www.vetkonect.com/dashboard/vet-vendor?vet={selectedVet?.id}
            &category={category}
          </p>
          <div className="flex items-center py-3 justify-center flex-col">
            <button
          ...
          {isOwnAccount ? (
            ...
            <>
              <p className="text-sm mt-2 w-60 m-auto text-gray-55 font-normal ">
                {" "}
                We would like for you to rate this user on a scale of 1 to
                5{" "}
              </p>
