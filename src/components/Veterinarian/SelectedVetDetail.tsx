...
const SelectedVet = ({
  ...
  const profileImageSrc = selectedVet
    ? resolveProfileImageSrc(selectedVet.image)
    : null;
            ...
            <div className="flex max-w-sm w-full justify-center px-4 relative md:px-0 m-auto flex-col items-center -mt-14">
              ...
              <div className="text-center">
                <h1 className="mt-3 text-lg font-semibold">
                  {selectedVet.role === "Veterinarian" ? "Dr." : " "}{" "}
                  {selectedVet.name}
                </h1>
              ...
              <div className="flex w-full border-b pb-5 border-gray-225 justify-center items-center md:gap-3 gap-2">
                <button
                  onClick={() => handleContact?.(selectedVet.id, "phone")}
                ...
                <button
                  onClick={() => handleContact?.(selectedVet.id, "message")}
                  className="flex flex-col justify-center items-center space-y-3 text-gray-500"
                >
                  <span
                ...
                <button
                  onClick={() => handleContact?.(selectedVet.id, "mail")}
                  className="flex flex-col justify-center items-center space-y-3 text-gray-500"
                >
                  <span
                ...
                <button
                  onClick={() => handleContact?.(selectedVet.id, "location")}
                  className="flex flex-col justify-center items-center space-y-3 text-gray-500"
                >
                  <span
                ...
                <button
                  onClick={() => handleContact?.(selectedVet.id, "share")}
                  className="flex flex-col justify-center items-center space-y-3 text-gray-500"
                >
                  <span
                ...
                <button
                  onClick={() => handleContact?.(selectedVet.id, "rate")}
                  className="flex flex-col justify-center items-center space-y-3 text-gray-500"
                >
                  <span
