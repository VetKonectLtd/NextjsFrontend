...
import ButtonBg from "@/app/assets/icons/vet-vendor/button-bg.svg";
				...
				<div className="absolute top-3 left-3 flex items-center gap-2 z-10">
					{open && (
						<div className="flex items-center bg-white rounded-lg px-5 py-1 shadow text-xs font-medium">
							<span className="w-2 h-2 rounded-full bg-[#52CE06] mr-1 inline-block" />
							Open
						</div>
					)}
				</div>
				<div className="absolute rounded-full text-white p-1 bg-[#52CE06] top-3 right-3 z-10">
					<Check size={14} />
				</div>
			</div>
			...
			<div className="p-2 pb-5">
				...
				<div className="flex items-center justify-between px-2 mt-3">
					<div className="flex items-center gap-3">
						<button className="bg-white border cursor-pointer border-[#EBEBEB] shadow-md rounded-full p-2">
							<Phone size={14} color="#1D2432" />
						</button>
						<button className="bg-white border border-[#EBEBEB] shadow-md rounded-full p-2">
