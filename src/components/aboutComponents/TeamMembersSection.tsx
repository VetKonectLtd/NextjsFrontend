...
const teamMembers: TeamMember[] = [
	{
		...
		role: "CEO",
		description:
			"Veterinary expert with 10+ years experience in animal healthcare across Africa.",
		image: Team1,
	...
	},
	{
		...
		role: "COO",
		description:
			"Chief Operating Officer overseeing operations and strategic initiatives.",
		image: Abiodun,
		bgColor: "bg-blue-100",
	},
	{
	...
	},
	{
		...
		description:
			"Content writer creating engaging stories and educational materials.",
		image: Godwin,
...

  {
		...
		description:
			"Graphics designer creating visual content and brand materials.",
		image: Jacob,
		bgColor: "bg-white",
	},

 {
	...
	},
	{
		...
		description:
			"Volunteer coordinator managing community initiatives and programs.",
		image: Osakuni,
		bgColor: "bg-white",
	},
];
