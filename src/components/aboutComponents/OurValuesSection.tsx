...
const values: ValueItem[] = [
  {
    ...
    title: "Vision",
    description:
      "A future where animal owners across Africa have no barriers to animal care and social protection.",
  ...
  },
  {
    ...
    title: "Mission",
    description:
      "To leverage technology to provide animal care and social protection for animal owners across Africa.",
    bgColor: "bg-green-50",
    iconBg: "bg-green-200",
    iconColor: "text-green-700",
  },
  {
    ...
    title: "Culture",
    description:
      "At Vet Konect, we believe it all begins with taking initiative.",
    bgColor: "bg-red-50",
    iconBg: "bg-red-200",
