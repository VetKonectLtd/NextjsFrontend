...
const FarmCard = ({ name,image, numOfWorkers, location, typeOfLivestock,numOfLivestock, sex, age }: any) => (
  <div className="bg-white shadow-md rounded-xl border border-gray-200 p-4 flex flex-col gap-4">
    ...
    <div className="mt-2 space-y-2 text-sm text-gray-55">
      <p className="flex md:flex-row flex-col justify-center items-center md:justify-between">
        <span className="font-semibold">Location / Address</span> {location}
      </p>
      <p className="flex md:flex-row flex-col justify-center items-center md:justify-between">
        <span className="font-semibold">Number of Workers</span> {numOfWorkers} Workers
      </p>
       <p className="flex md:flex-row flex-col justify-center items-center md:justify-between">
        <span className="font-semibold">Type of Livestock</span> {typeOfLivestock}
      </p>
       <p className="flex md:flex-row flex-col justify-center items-center md:justify-between">
        <span className="font-semibold">Number of Livestock</span> {numOfLivestock} Livestock
      </p>
      <p className="flex md:flex-row flex-col justify-center items-center md:justify-between">
