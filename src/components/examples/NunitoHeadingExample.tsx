  ...
  return (
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      ...
      <p className="font-inter text-base leading-relaxed">
        This paragraph uses Inter font for body text, which pairs nicely with
        Nunito headings.
      </p>
      ...
      <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-6 rounded-lg">
        ...
        <p className="font-inter text-primary-700">
          Simply add the className "font-nunito" to any heading element (h1-h6)
          along with your desired text size and weight. For example:
          className="font-nunito text-3xl font-semibold"
        </p>
      </div>
    </div>
  );
