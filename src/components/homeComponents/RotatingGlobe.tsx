    ...
    import("globe.gl").then((GlobeModule) => {
      ...
      try {
        ...
        if (controls) {
          ...
          controls.autoRotateSpeed = window.innerWidth < 640 ? 0.5 : 1.0;
        }
      } catch {}
    ...
    <div className="relative w-full h-[350px] sm:h-[500px] md:h-[600px] overflow-hidden mt-10 sm:mt-0">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[15%] left-[15%] sm:left-[25%] -translate-x-1/2 -translate-y-1/2">
          <img
            src={
              typeof globeImageTopLeft === "string"
                ? globeImageTopLeft
                : globeImageTopLeft.src
            }
        ...
        <div className="absolute top-[15%] right-[15%] sm:right-[25%] translate-x-1/2 -translate-y-1/2">
          <img
            src={
              typeof globeImageTopRight === "string"
                ? globeImageTopRight
                : globeImageTopRight.src
            }
        ...
        <div className="absolute top-1/2 left-[10%] sm:left-[15%] -translate-x-1/2 -translate-y-1/2">
          <img
            src={
              typeof globeImageMiddleLeft === "string"
                ? globeImageMiddleLeft
                : globeImageMiddleLeft.src
            }
        ...
        <div className="absolute top-1/2 right-[10%] sm:right-[15%] translate-x-1/2 -translate-y-1/2">
          <img
            src={
              typeof globeImageMiddleRight === "string"
                ? globeImageMiddleRight
                : globeImageMiddleRight.src
            }
            className="w-12 h-12 sm:w-20 sm:h-20 object-contain"
            alt=""
          />
        ...
        <div className="absolute bottom-[15%] left-[15%] sm:left-[50%] -translate-x-1/2 translate-y-1/2">
          <img
            src={
              typeof globeImageBottomLeft === "string"
                ? globeImageBottomLeft
                : globeImageBottomLeft.src
            }
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <img
            src={
              typeof globeImageCenter === "string"
                ? globeImageCenter
                : globeImageCenter.src
            }
