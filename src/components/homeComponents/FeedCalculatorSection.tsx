              ...
              <div className="flex gap-6 mb-6">
                ...
                <div className="text-left space-y-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Discover the appropriate amount of feed to give your
                    livestock to stay healthy and productive
                  </p>
                </div>
              </div>
            ...
            <div className="p-8 flex-1 flex flex-col">
              ...
              <div className="flex gap-6 mb-6">
                ...
                <div className="text-left space-y-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Diagnose and treat various diseases in animals to improving
