...
import { Messages } from "@/app/assets/icons";
...
const ChatBox = ({ selectedVet }: any) => {
	...
	return (
		<>
			{selectedVet && (
				<div className="w-full h-auto border rounded-lg shadow-md bg-white relative">
					{/* Header */}
			...
			{!selectedVet && (
					<div className="w-full h-full border flex flex-col text-center px-10 items-center justify-center border-gray-225 rounded-lg shadow-md bg-white relative">
						<div className="max-w-xs m-auto">
							...
							<h2 className="text-gray-55 font-semibold text-base">
								{" "}
								No Details
							</h2>
							<p className="text-gray-55 font-normal text-sm">
								Click on any of the messages displayed at your left side to view
								message details.
							</p>
						</div>
					</div>
