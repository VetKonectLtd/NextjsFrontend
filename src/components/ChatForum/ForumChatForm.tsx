        ...
        <div className="w-full px-6 mt-5 mx-auto">
          ...
          <form className="space-y-2">
            ...
            <div className="flex flex-col">
              {preview ? (
                <>
                  <div className="md:w-[300px] w-full h-[300px] border-2 border-gray-225 rounded-md overflow-hidden mb-2 flex items-center justify-center">
                    <Image
                      src={preview || ""}
                      alt="Preview"
                      width={200}
                ...
                <>
                  <label
                    ...
                    className="md:w-[300px] w-full h-[300px] flex flex-col items-center bg-[#F1F1F1] justify-center border border-gray-55 rounded-md cursor-pointer mb-2"
                  >
