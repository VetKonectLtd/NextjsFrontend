...
export function Typography({
  ...
  const getVariantClasses = (variant: string, font?: string): string => {
      ...
      switch (font) {
        case "inter":
          if (variant in typography.bodyInter) {
            return typography.bodyInter[
              variant as keyof typeof typography.bodyInter
            ];
          }
          break;
        case "poppins":
          if (variant in typography.heading) {
            return typography.heading[
              variant as keyof typeof typography.heading
            ];
          }
          break;
        case "open-sans":
    ...
    if (variant in typography.headingNunito) {
      return typography.headingNunito[
        variant as keyof typeof typography.headingNunito
      ];
    }
...
export const BodyInter = ({
  className,
  ...props
}: Omit<TypographyProps, "variant" | "font">) => (
  <Typography variant="base" font="inter" className={className} {...props} />
);

export const BodyLargeInter = ({
  className,
  ...props
}: Omit<TypographyProps, "variant" | "font">) => (
