  ...
  return (
    ...
    >
      <div className="md:w-5/6 mx-auto text-center">
        ...
        >
          Vetkonect Animal Welfare & Sustainability Foundation is a nonprofit
          organization committed to advancing the health and well-being of
          animals, humans, and the community through evidence-based veterinary
          interventions, community engagement, and policy advocacy. Recognizing
          the interconnectedness of animal, human, and environmental health, the
          foundation adopts a One Health approach to address critical
          challenges, including wildlife conservation, climate change, animal
          welfare, antimicrobial resistance (AMR) and the prevention of zoonotic
          diseases.
        </motion.p>
      </div>
    </motion.section>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:py-9  pb-20 items-center">
          ...
          >
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              Established to bridge the gap between veterinary expertise, public
              health, and environmental sustainability, Vetkonect Animal Welfare
              & Sustainability Foundation serves as a hub for conservation,
              education, and advocacy. By fostering collaboration among
              communities, governments, academic institutions, and international
              organizations, the foundation seeks to create a future where
              humans, animals, and ecosystems thrive together.
            </p>
          </motion.div>
      ...
      <div className="w-full">
        ...
        <section className="relative mt-2 h-screen w-full overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col bg-black/40 h-full  items-center justify-center my-auto p-6 py-5 text-center px-6">
            ...
            >
              An Outreach carried out at Maiduguri state to sensitize farmers,
              butchers on zoonotic diseases like Brucellosis.
            </motion.p>
