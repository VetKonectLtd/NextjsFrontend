...
const slides = [{ image: Hero11 }, { image: Focus3 }, { image: Hero13 }];
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <p className="text-gray-500 text-sm text-center">
                  Reach out to us directly via any of the channels below and
        ...
        {donateOpen && (
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <p className="text-gray-500 text-sm text-center">
                  Make a transfer to any of the accounts below and help us
                  continue our mission for animal welfare.
                </p>
...
function InputField({ label, type = "text", error, inputProps }: any) {
  return (
    <div>
