  ...
  return (
    <div className="mt-12 pb-3 text-center w-full m-auto text-gray-500 text-sm">
      ...
      {selectedAction === "point" && (
        <>
          {/* TITLE */}
          <p className="text-gray-55 text-2xl font-bold">Your Reward Points</p>

          <p className="text-sm mt-2 w-72 m-auto text-gray-55">
            Earn points through engagement and successful referrals on
            VetKonect.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-5 w-72 m-auto">
            Invite friends and stay active to earn more rewards and unlock
            future benefits.
          </p>
        </>
      )}
